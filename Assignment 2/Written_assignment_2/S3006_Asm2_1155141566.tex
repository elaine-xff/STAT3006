...
\end{flalign*}
By Lagrange Multiplier, $n_i = \frac{1000\mu_i\sqrt{V_i}}{\sum_{k=1}^3 \mu_k \sqrt{V_k}}$. We use standard deviations estimated in part a to compute variance here.
...
By randomly drawing $n_i$ samples in strata $i$ for each $i$, the eatimated population mean salary based on these 1000 samples is 4607.275, which
