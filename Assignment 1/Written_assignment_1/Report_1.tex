...
\begin{flalign}
    \pi_1^{(t+1)} &= \frac{\sum_{i=1}^n I(Z_i^{(t)} = 1)}{\sum_{i=1}^n I(Z_i^{(t)} = 1) + \sum_{i=1}^n I(Z_i^{(t)} = 2) + \sum_{i=1}^n I(Z_i^{(t)} = 3)}\\
    \pi_2^{(t+1)} &= \frac{\sum_{i=1}^n I(Z_i^{(t)} = 2)}{\sum_{i=1}^n I(Z_i^{(t)} = 1) + \sum_{i=1}^n I(Z_i^{(t)} = 2) + \sum_{i=1}^n I(Z_i^{(t)} = 3)}\\
