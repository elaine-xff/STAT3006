...
\result{$\hat{\pi_1} = 0.6464652, \hat{\pi_2} = 0.2498821, \hat{\mu_1} = 2999.048, \hat{\mu_2} = 8004.365, \hat{\mu_3} = 29848.78, 
\hat{\sigma_1} = 303.3709, \hat{\sigma_2} = 1515.854$ and $\hat{\sigma_3} = 7963.118$}
