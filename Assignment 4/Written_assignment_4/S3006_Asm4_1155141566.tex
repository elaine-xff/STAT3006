...
1. E-step: Compute conditional expectation values to be stored in an $n \times 3$ matrix, in which the computation tasks are distributed in columns.\\
2. M-step: \\
...
The master gather all values computed before and then distribute tasks about updating 8 parameters in load balance scheme or if \# of cores $>$ \# of parameters, we can just distribute tasks to ($n =$ \# of parameters) cores.
